...
c
c                     Finite-Difference Forward Modelling using the
...
c   become diffractions, interfaces should increase both dip and length etc...
c
c   This process will most likely be used in conjunction with processes SYN
