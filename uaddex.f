...
C     UADDEX IS THE EXECUTION PHASE OF THE SEISMIC REFLECTION PROCESS UADD
C  (USER GIVEN TRACE ADDITION).  THE USER'S PARAMETERS MUST BE IN
C  DISC FILE MUNIT (IN COMMON /UADD/) AND THE TRACE WITH TRACE HEADER
