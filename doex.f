...
c  5 Feb 14 - Don't set the output segy rev to 1 if the input
...
c  7 Oct 14 - Use swp_trhdr for trace header byte swap so diskin and disko are the same
c  7 Feb 15 - common /readt/ was wrong
c  15 Nov 15 - zero the rev 1 delay scalar when SET is used
c  25 Jul 18 - SET was off by 1 sample
c
