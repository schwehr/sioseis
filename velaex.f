...
C     SUBROUTINE VELAED CONTANS THE EXPLAINATION OF THE USER PARAMETERS AND THE
...
C
C  ARGUMENTS:
C  BUF    - THE TRACE TO BE ANALIZED, INCLUDING THE TRACE HEADER.  THE FIRST
...
C****
 1050 TINC=WINLEN/2.
      ISHIFT=(X/VEL)/SI+SI2
      DO 1055 I=1,N                                                      /* BUILD AN ARRAY OF INDEXS
...
C*** VALUES.
                      ...
                      ibuf(13) = 5
                      ibuf(15) = 1
C***GMK WRITE OUT TAPE ID HEADER WITH APPROPRIATE VAULES FOR SEMBLANCE
